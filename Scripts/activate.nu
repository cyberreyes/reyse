...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Admin\Django_Dev_Reyes\FirstDjango_Reyes'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Admin\Django_Dev_Reyes\FirstDjango_Reyes\Scripts\deactivate.nu'
